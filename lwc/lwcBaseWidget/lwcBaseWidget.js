...
import actionInProgressTemplate from './lwcBaseWidget_ActionInProgressTemplate.html';
import errorStateTemplate from './lwcBaseWidget_ErrorStateTemplate.html';

/*
    Provides a default implementation of an LWC-based "widget" component type.
*/
export default class LwcBaseWidget extends LightningElement {

    //Specifies the overall title of the widget-based component typically displayed in the component header.
    @api componentTitle;
